...
IF @VAR_PRE_ORDRE =0
SET @VAR_PRE_ORDRE=1;
SELECT @VAR_PRE_DATEDEBUT=01/01/2020 --reprise au premier mois de la reprise sur Sprint sinon le logiciel vient régulariser depuis le début car il n'a pas d'historique des retenues
