...
IF @VAR_PRE_ORDRE =0
SET @VAR_PRE_ORDRE=1;
SELECT @VAR_PRE_DATEDEBUT=CAST(CONCAT(PEDEB,'01') AS datetime) FROM PENSIONALIMENTAIRE WHERE PENSIONALIMENTAIRE_LIGNE=@VAR_PENSION_EN_COURS; --récupération de la date de début de la saisie
