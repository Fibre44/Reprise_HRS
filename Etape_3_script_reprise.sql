...
SELECT IND_SIREN,IND_MATRICULEHRS,IQIDEN 
FROM VENTILATION_INDIVIDUS
LEFT JOIN TRSMATRICULE ON MATRI=IND_MATRICULEHRU;
...
@VAR_PCN_LIBELLE,@VAR_PCN_JOURS,@VAR_PCN_HEURES,@VAR_PCN_BASE,@VAR_PCN_DEBUTDJ,@VAR_PCN_FINDJ,@VAR_PCN_TRAVAILN1,@VAR_PCN_TRAVAILN2,@VAR_PCN_TRAVAILN3,@VAR_PCN_TRAVAILN4,@VAR_PCN_TYPEMVT,@VAR_PCN_PERIODECP,@VAR_PCN_PERIODEPY,@VAR_PCN_TYPEIMPUTE,@VAR_PCN_ETATPOSTPAIE,@VAR_PCN_CODETAPE,@VAR_PCN_NBREMOIS);
...
--Reprise des RTT acquis

DECLARE REPRISERTTACQUIS_CURSOR CURSOR FOR

SELECT IND_SIREN,PSA_ETABLISSEMENT,IND_MATRICULEHRS,CAST(CONCAT(PCPTA,'01') AS datetime), CAST(DTRES AS datetime),VLRES,PSA_TRAVAILN1,PSA_TRAVAILN2,PSA_TRAVAILN3,PSA_TRAVAILN4,PSA_CODESTAT,PSA_LIBREPCMB1,PSA_LIBREPCMB2,PSA_LIBREPCMB3,PSA_LIBREPCMB4
FROM VENTILATION_INDIVIDUS
LEFT JOIN COMPTEURS ON MATRI=IND_MATRICULEHRU AND CEMP=IND_CEMP
INNER JOIN HR_SPRINT_SALARIES ON PSA_SALARIE=IND_MATRICULEHRS AND IND_SIREN=PSA_SIREN
WHERE CDRG='RTD';

OPEN REPRISERTTACQUIS_CURSOR
FETCH NEXT FROM REPRISERTTACQUIS_CURSOR
INTO @VAR_PHC_SIREN,@VAR_PHC_ETABLISSEMENT,@VAR_PHC_SALARIE,@VAR_PHC_DATEDEBUT,@VAR_PHC_DATEFIN,@VAR_PHC_MONTANT,@VAR_PHC_TRAVAILN1,@VAR_PHC_TRAVAILN2,@VAR_PHC_TRAVAILN3,@VAR_PHC_TRAVAILN4,@VAR_PHC_CODESTAT,@VAR_PHC_LIBREPCMB1,@VAR_PHC_LIBREPCMB2,@VAR_PHC_LIBREPCMB3,@VAR_PHC_LIBREPCMB4;

SET @VAR_PHC_CUMULPAIE='RTD'
...
CLOSE REPRISERTTACQUIS_CURSOR;  
DEALLOCATE REPRISERTTACQUIS_CURSOR; 

--Reprise des RTT pris

DECLARE REPRISERTTPRISS_CURSOR CURSOR FOR
...
OPEN REPRISERTTPRISS_CURSOR
FETCH NEXT FROM REPRISERTTPRISS_CURSOR
INTO @VAR_PHC_SIREN,@VAR_PHC_ETABLISSEMENT,@VAR_PHC_SALARIE,@VAR_PHC_DATEDEBUT,@VAR_PHC_DATEFIN,@VAR_PHC_MONTANT,@VAR_PHC_TRAVAILN1,@VAR_PHC_TRAVAILN2,@VAR_PHC_TRAVAILN3,@VAR_PHC_TRAVAILN4,@VAR_PHC_CODESTAT,@VAR_PHC_LIBREPCMB1,@VAR_PHC_LIBREPCMB2,@VAR_PHC_LIBREPCMB3,@VAR_PHC_LIBREPCMB4;

SET @VAR_PHC_CUMULPAIE='RTP'
...
CLOSE REPRISERTTPRISS_CURSOR;  
DEALLOCATE REPRISERTTPRISS_CURSOR; 
