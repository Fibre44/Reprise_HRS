...
--Gestion des Nom de jeune fille

UPDATE HR_SPRINT_SALARIES SET PSA_LIBELLE=PSA_NOMJF WHERE PSA_SEXE='M';
UPDATE HR_SPRINT_SALARIES SET PSA_NOMJF='' WHERE PSA_SEXE='M';
