...
ELSE --si le salarié n'est pas encore migré
	...
	BEGIN
		...
		--Table source INDIVIDU
			...
			@VAR_PSA_REGIMEMAL,@VAR_PSA_REGIMEVIP,@VAR_PSA_REGIMEAT,@VAR_PSA_TYPDSNFRAC,@VAR_PSA_DSNFRACTION,@VAR_PSA_TYPENATTAUXPAS,@VAR_PSA_NATURETAUXPAS,@VAR_PSA_UNITETRAVAIL,@VAR_PSA_MOTIFSORTIE,@VAR_PSA_HORHEBDO,@VAR_PSA_ETATBULLETIN);
