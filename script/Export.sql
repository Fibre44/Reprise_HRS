...
SELECT $(COLONNE1),$(COLONNE2),ENFANTSALARIE,PEF_SALARIE,PEF_ENFANT,PEF_NOM,PEF_PRENOM,PEF_DATENAISSANCE,PEF_ACHARGE,PEF_SEXE,PEF_TYPEPARENTAL FROM HR_SPRINT_ENFANTSALARIE WHERE PEF_SIREN=$(SIREN);
!!:GO  
