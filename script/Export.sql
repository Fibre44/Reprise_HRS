...
:setvar  SIREN
:out .\fichiers_hrs\MINIMUMCONVENT.asc
...
SELECT $(COLONNE1),$(COLONNE2),CONTRATTRAVAIL,PCI_SALARIE,PCI_ORDRE,PCI_TYPECONTRAT,CONVERT(char(10),PCI_DEBUTCONTRAT,103) AS PCI_DEBUTCONTRAT,CONVERT(char(10),PCI_FINCONTRAT,103),PCI_STATUTBOETH AS PCI_FINCONTRAT, PCI_ETABLISSEMENT,PCI_ETABLIEUTRAV,PCI_DNASITUATADM,PCI_PERPAIEMENTSAL,PCI_INTITULCONTRAT,PCI_TYPECDD,PCI_REGIMELOCALDSN,PCI_QUOTITE,PCI_TYPEINSEE,PCI_CODEINSEE,PCI_ANCIENNUM,PCI_PASEXCLU,PCI_DNACODUNITEHOR,PCI_SALARIEREMPL,PCI_LIBELLEEMPLOI,PCI_MOTIFCTINT,PCI_MOTIFSORTIE,PCI_SIRETANCIEN,CONVERT(char(10),PCI_DATEANCSIRET,103) FROM HR_SPRINT_CONTRATTRAVAIL WHERE PCI_SIREN=$(SIREN);
!!:GO  
