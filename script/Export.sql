...
SELECT DEPORTSAL,PSE_SALARIE,PSE_EMAILPROF FROM HR_SPRINT_DEPORTSAL WHERE PSE_SIREN=$(SIREN);
!!:GO  
...
SELECT SALARIESCOMPL,PSZ_SALARIE,PSZ_DIGITALIDENT FROM HR_SPRINT_SALARIECOMPL WHERE PSZ_SIREN=$(SIREN);
!!:GO  
...
SELECT ENFANTSALARIE,PEF_SALARIE,PEF_ENFANT,PEF_NOM,PEF_PRENOM,PEF_DATENAISSANCE,PEF_ACHARGE,PEF_SEXE,PEF_TYPEPARENTAL FROM HR_SPRINT_ENFANTSALARIE WHERE PEF_SIREN=$(SIREN);
!!:GO  
...
SELECT PGHISTODETAIL,PHD_SALARIE,PHD_ETABLISSEMENT,PHD_PGINFOSMODIF,PHD_PGTYPEHISTO,PHD_NEWVALEUR,PHD_TYPEVALEUR,PHD_TABLETTE,PHD_PGTYPEINFOLS,PHD_DATEAPPLIC,PHD_TRAITEMENTOK,PHD_CODTABL,PHD_CODEPOP,PHD_POPULATION FROM HR_SPRINT_PGHISTODETAIL WHERE PHD_SIREN=$(SIREN);
!!:GO  
