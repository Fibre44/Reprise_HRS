...
:out .\temp\HISTOBULLETIN.asc 
SELECT $(COLONNE1),$(COLONNE2),HISTOBULLETIN,PHB_ETABLISSEMENT,PHB_SALARIE,CONVERT(char(10),[PHB_DATEDEBUT],103),CONVERT(char(10),[PHB_DATEFIN],103),PHB_NATURERUB,PHB_RUBRIQUE,PHB_LIBELLE,PHB_IMPRIMABLE,PHB_BASECOT FROM HR_SPRINT_HISTOBULLETIN WHERE PHB_SIREN=$(SIREN);
!!:GO  
