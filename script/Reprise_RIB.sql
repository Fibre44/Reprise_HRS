...
@VAR_NOM_TABLE char (3);

SET @VAR_NOM_TABLE='RIB';
...
BEGIN
	...
	BEGIN
		...
		BEGIN
			...
			@VAR_R_CODEBIC,@VAR_R_DOMICILIATION,@VAR_R_SALAIRE,@VAR_R_ACOMPTE,@VAR_R_PAYS,@VAR_R_DEVISE,@VAR_NOM_TABLE);

			UPDATE VENTILATION_INDIVIDUS SET IND_STATUS='Etape RIB', IND_REPRISE_HR_SPRINT_RIB='X' WHERE IND_AUXILIAIRE=@VAR_R_AUXILIAIRE AND IND_SIREN=@VAR_R_SIREN; --mise é jour du statuts
