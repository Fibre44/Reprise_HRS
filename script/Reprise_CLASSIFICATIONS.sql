...
@VAR_CTA06_VALEUR_HRU varchar(35),
@VAR_CTA06_VALEUR_HRS varchar(35),
@VAR_CTA06_TEMPORAIRE varchar(35),
@VAR_CTA06_VALEUR_HRU_TRANSCO varchar(35),
...
BEGIN 
	...
	BEGIN
		...
		SELECT @VAR_CTA02_VALEUR_HRU=CTA02 FROM VALIDCONTRAT WHERE VALIDCONTRAT_LIGNE=@VAR_CONTRAT_EN_COURS;--r�cup�ration du code travail n3
		...
		SELECT @VAR_CTA03_VALEUR_HRU=CTA03 FROM VALIDCONTRAT WHERE VALIDCONTRAT_LIGNE=@VAR_CONTRAT_EN_COURS;--r�cup�ration du code travail n3
		...
		SELECT @VAR_CTA04_VALEUR_HRU=CTA04 FROM VALIDCONTRAT WHERE VALIDCONTRAT_LIGNE=@VAR_CONTRAT_EN_COURS;--r�cup�ration du code travail n
		...
		SELECT @VAR_CTA05_VALEUR_HRU=CTA05 FROM VALIDCONTRAT WHERE VALIDCONTRAT_LIGNE=@VAR_CONTRAT_EN_COURS;--r�cup�ration du code travail n
		...
		SELECT @VAR_CTA06_VALEUR_HRU=CTA06 FROM VALIDCONTRAT WHERE VALIDCONTRAT_LIGNE=@VAR_CONTRAT_EN_COURS;--r�cup�ration du code travail n
		SELECT @VAR_CTA06_VALEUR_HRU_TRANSCO=COUNT(*) FROM TRANSCO WHERE TRA_VALEURHRU=@VAR_CTA05_VALEUR_HRU;--controle si la valeur existe				
	...
	IF @VAR_CTA02_VALEUR_HRU_TRANSCO=0 --Ajout d'un nouveau code emploi
		...
		BEGIN
			...
			SET @VAR_CTA03_TEMPORAIRE=@VAR_CTA03_TEMPORAIRE+1;--incr�mentation du code
		...
		ELSE --si le code CTA03 existe d�j�
		...
		BEGIN
			...
			PRINT 'Le code CTA03 de HRU '+@VAR_CTA03_VALEUR_HRU+' a d�j� �t� trait� contrat en cours '+CAST(@VAR_CONTRAT_EN_COURS AS varchar(255))+'/'+CAST(@VAR_CONTRAT_TOTAL AS VARCHAR(255)) 
		END
	...
	IF @VAR_CTA02_VALEUR_HRU_TRANSCO=0 --Ajout d'un nouveau code emploi
		...
		BEGIN
			...
			SET @VAR_CTA04_TEMPORAIRE=@VAR_CTA04_TEMPORAIRE+1;--incr�mentation du code
		...
		ELSE --si le code CTA04 existe d�j�
		...
		BEGIN
			...
			PRINT 'Le code CTA04 de HRU '+@VAR_CTA04_VALEUR_HRU+' a d�j� �t� trait� contrat en cours '+CAST(@VAR_CONTRAT_EN_COURS AS varchar(255))+'/'+CAST(@VAR_CONTRAT_TOTAL AS VARCHAR(255)) 
		END
	...
	IF @VAR_CTA02_VALEUR_HRU_TRANSCO=0 --Ajout d'un nouveau code emploi
		...
		BEGIN
			...
			SET @VAR_CTA05_VALEUR_HRS=@VAR_CTA05_TEMPORAIRE+1;--incr�mentation du code
		...
		ELSE --si le code CTA05 existe d�j�
		...
		BEGIN
			...
			PRINT 'Le code CTA05 de HRU '+@VAR_CTA05_VALEUR_HRU+' a d�j� �t� trait� contrat en cours '+CAST(@VAR_CONTRAT_EN_COURS AS varchar(255))+'/'+CAST(@VAR_CONTRAT_TOTAL AS VARCHAR(255)) 
		END

	--Gestion du code CTA06
	
	IF @VAR_CTA06_VALEUR_HRU_TRANSCO=0 --Ajout d'un nouveau code emploi

		BEGIN
						
			SET @VAR_TRANSCO_TYPE='CTA06';
			SET @VAR_NATURECONTROLE='Transco travail CTA06';
			SET @VAR_RESULTATCONTROLE='Ok';

			SELECT @VAR_CTA06_TEMPORAIRE=COUNT(*) FROM TRANSCO WHERE TRA_TYPE='CTA06' AND TRA_SIREN=@VAR_TRA_SIREN;

			SET @VAR_CTA06_VALEUR_HRS=@VAR_CTA06_TEMPORAIRE+1;--incr�mentation du code
	
			IF @VAR_CTA06_TEMPORAIRE<10 --ajout des 0
			
			BEGIN
				SET @VAR_CTA06_VALEUR_HRS=CONCAT('00',CAST(@VAR_CTA06_TEMPORAIRE AS char(3)));--passage au format texte
			END

			IF @VAR_CTA06_TEMPORAIRE>10 AND @VAR_EMPLOI_TEMPORAIRE<100 

			BEGIN
				SET @VAR_CTA06_VALEUR_HRS=CONCAT('0',CAST(@VAR_CTA06_TEMPORAIRE AS char(3)));--passage au format texte
			END
		
			IF @VAR_CTA06_TEMPORAIRE>100 

			BEGIN
				SET @VAR_CTA06_VALEUR_HRS=CAST(@VAR_CTA06_TEMPORAIRE AS char(3));--passage au format texte
			END
				

			INSERT INTO TRANSCO
			VALUES (@VAR_TRANSCO_TYPE,@VAR_CTA06_TEMPORAIRE,@VAR_CTA06_TEMPORAIRE,@VAR_TRA_SIREN);
		...
		ELSE --si le code CTA06 existe d�j�

		BEGIN

			SET @VAR_TRANSCO_TYPE='CTA06';
			SET @VAR_NATURECONTROLE='Transco CTA06';
			SET @VAR_RESULTATCONTROLE='Ok';

			PRINT 'Le code CTA06 de HRU '+@VAR_CTA06_VALEUR_HRU+' a d�j� �t� trait� contrat en cours '+CAST(@VAR_CONTRAT_EN_COURS AS varchar(255))+'/'+CAST(@VAR_CONTRAT_TOTAL AS VARCHAR(255)) 
		END
