...
WHILE @@FETCH_STATUS = 0 
	...
	BEGIN
		...
		BEGIN
			...
			BEGIN
				...
				PRINT 'Supérieur plafond et à la T2' 	
			END
		END
	END
	...
	IF CAST(@VAR_PHB_BASECOT as real)=@VAR_CONTROLE_BASE --si controle ok

	BEGIN
		Print 'Controle des bases pour le matricule '+@VAR_PHB_SALARIE+' est ok sur le mois '+Cast(@VAR_PHB_DATEDEBUT as varchar(255))
	...
	BEGIN
		...
		SET @VAR_ANOMALIES_COMMENTAIRES='Controle des bases pour le matricule '+@VAR_PHB_SALARIE+' est ko sur le mois '+Cast(@VAR_PHB_DATEDEBUT as varchar(255))
