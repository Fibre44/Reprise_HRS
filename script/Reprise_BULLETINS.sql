...
INTO @VAR_PHB_SIREN,@VAR_PHB_ETABLISSEMENT,@VAR_PHB_SALARIE,@VAR_PHB_DATEDEBUT,@VAR_PHB_DATEFIN,@VAR_PHB_RUBRIQUE,@VAR_PHB_BASECOT,@VAR_PHB_TAUXREM,@VAR_PHB_MTREM,@VAR_PHB_TRAVAILN1,@VAR_PHB_TRAVAILN2,@VAR_PHB_TRAVAILN3,@VAR_PHB_TRAVAILN4,@VAR_PHB_CODESTAT,@VAR_PHB_LIBREPCMB1,@VAR_PHB_LIBREPCMB2,@VAR_PHB_LIBREPCMB3,@VAR_PHB_LIBREPCMB4;
