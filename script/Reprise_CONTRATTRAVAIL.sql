...
WHILE @VAR_CONTRAT_EN_COURS<=@VAR_TOTAL_CONTRAT --boucle par contrat
	...
	@VAR_PCI_TYPEINSEE,@VAR_PCI_CODEINSEE,@VAR_PCI_ANCIENNUM,@VAR_PCI_PASEXCLU,@VAR_PCI_DNACODUNITEHOR,@VAR_PCI_SALARIEREMPL,@VAR_PCI_LIBELLEEMPLOI,@VAR_PCI_MOTIFCTINT,@VAR_PCI_MOTIFSORTIE,@VAR_PCI_SIRETANCIEN,@VAR_NOM_TABLE,@VAR_PCI_DATEANCSIRET);
