...
ELSE --si le salarié n'est pas encore migré
	...
	BEGIN
		...
		--Table source INDIVIDU
			...
			@VAR_PSA_DATEANCIENNETE=CAST(DDANC AS datetime), --récupération derniére datetime d'ancienneté
			...
			@VAR_PSA_PROFILMUT,@VAR_PSA_TYPPROFIL,@VAR_PSA_TYPPROFILMUT,@VAR_PSA_TYPPROFILPRE,@VAR_PSA_TYPPROFILREM,@VAR_PSA_HORANNUEL,@VAR_PSA_CATDADS);
