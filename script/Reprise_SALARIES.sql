...
ELSE --si le salarié n'est pas encore migré
	...
	BEGIN
		...
		--Table source INDIVIDU
			...
			@VAR_PSA_HORANNUEL=NBJRF --récupération du nombre de jour du forfait
			FROM VALIDCONTRAT
			...
			BEGIN
				PRINT 'Mise é blanc des codes profils'
			...
			@VAR_PSA_PROFILMUT,@VAR_PSA_TYPPROFIL,@VAR_PSA_TYPPROFILMUT,@VAR_PSA_TYPPROFILPRE,@VAR_PSA_TYPPROFILREM,@VAR_PSA_HORANNUEL);
